...
namespace HeadBook
{
    public partial class Settings : System.Web.UI.Page
    {
        ...
        protected void btnSaveSettings_Click(object sender, EventArgs e)
        {
            ...
            lblError.Text = Objects.Settings.SaveUserSettings(Convert.ToString(Session["Username"]), ddlAutoLogin.SelectedValue, ddlPhotos.SelectedValue, ddlProfileInfo.SelectedValue, ddlContactInfo.SelectedValue, ddlFont.SelectedValue, ddlBackgroundColor.SelectedValue, ddlFontColor.SelectedValue);
        }
