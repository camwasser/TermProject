                    ...
                    <div class="collapse py-2" id="cardRegister">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-2 col-sm-8 pb-3 pt-2">
                                        <asp:Button ID="btnRegister" runat="server" class="btn btn-secondary-outline btn-lg btn-block" Text="Register" OnClick="btnRegister_Click" OnClientClick="return valReg()"></asp:Button>
                                    </div>
                                </div>
